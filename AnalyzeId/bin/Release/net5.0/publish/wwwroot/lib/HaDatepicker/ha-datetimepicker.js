...
function HaDateTimePicker(selector, options) {
    ...
    this.options = {
        ...
        isSolar: isSolar,
        isLunar: isLunar,
        maxYear: options.maxYear || (isSolar === true ? 1450 : isLunar === true ? 1480 : 2040),
        minYear: options.minYear || (isSolar === true ? 1350 : isLunar === true ? 1380 : 1900),
        ...
        for (var l = 0; l < weeks[x].daysOfWeek.length; l++) {
            ...
            if (dayOfMonth <= monthLastDay && dayOfMonth > 0) {
                ...
                if (this.options.isSolar || this.options.isLunar)
                    ...
                    holiday = l == 0 || l == 6 ? " ha-dp-cell-holiday" : "";
...
HaDateTimePicker.prototype.getFormatedResult = function () {
    ...
    do {
        ...
        formattedResult = formattedResult.replace("{month}", String(resultDate.getMonth() + 1).padStart(2, '0'))
            .replace("{day}", String(resultDate.getDate()).padStart(2, '0'))
